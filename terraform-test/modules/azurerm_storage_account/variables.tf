...
variable "email_receiver" {
    type = list
    description = "email reciver"
    default = ["constoso@gmail.com","vinay@gmail.com"]
}
*/


/*
variable "storage_account_log_analytics_workspace_name" {
    type = string
    description = "log analytics workspace name"
}
variable "storage_account_log_analytics_workspace_sku" {
    type = string
...
/*
variable "storage_account_diagnostic_storage_account_name" {
    type = string
    description = "diagnostic storage account  name"
}
variable "storage_account_diagnostic_storage_account_tier" {
    type = string
    description = "diagnostic storage account  tier details"
}
variable "storage_account_diagnostic_storage_account_tier_replication_type" {
    type = string
    description = "diagnostic storage account tier replication type"
}
